...
#grub issue 08/2022
alias install-grub-efi="sudo grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id=archlinux"
...
alias toboot="sudo /usr/local/bin/archlinux-toboot"
alias togrub="sudo /usr/local/bin/archlinux-togrub"
...
#iso and version used to install Helwan-Linux
